...
import com.example.myBlockchain.Block;
import com.example.myBlockchain.Blockchain;
import com.example.myBlockchain.MerkleTree;
import com.example.myBlockchain.Transaction;
import com.example.myCrypto.Asymmetric;
import com.example.myCrypto.Symmetric;
import com.example.myHash.Hasher;
import com.example.myHash.Salt;
import com.example.mySignature.MySignature;
import com.example.mykey.access.KeyPairAccess;
import com.example.mykey.maker.*;
...
public class Tester {
    public static void tstBlockchainWithAsymmSignature() throws Exception {
        ...
        // Example Tranx
        // Full Name|Identity Card Number|Date of Birth|Gender|Phone Number|
        String tranx1 = "John|010101010123|1 Jan 2001|Male|012-34567890";
        String tranx2 = "Alice|020202020234|2 Feb 2002|Female|012-33567890";
        ...
        String encrypted_tranx2 = asymm.encrypt(tranx2, publicKey);
    ...
    public static void tstMySignature() throws Exception {
        ...
        String data = "Simple digital signature";
